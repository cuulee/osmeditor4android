...
public final class Tags {
    ...
    public static final Map<String, Integer> ADDRESS_SORT_ORDER     = Collections
            .unmodifiableMap(ADDRESS_SORT_ORDER_TEMP);
    ...
    public static final List<String>         I18N_NAME_KEYS         = Collections.unmodifiableList(Arrays.asList(
            KEY_NAME, KEY_OFFICIAL_NAME, KEY_ALT_NAME, KEY_LOC_NAME, KEY_SHORT_NAME, KEY_REG_NAME, KEY_NAT_NAME));
    ...
    /**
     * An set of tags considered 'important'. These are typically tags that define real-world objects and not properties of such.
     */
    public static final Set<String> IMPORTANT_TAGS    = Collections.unmodifiableSet(
            new HashSet<>(Arrays.asList(KEY_HIGHWAY, KEY_BARRIER, KEY_WATERWAY, KEY_RAILWAY, KEY_AEROWAY, KEY_AERIALWAY,
                    KEY_POWER, KEY_MAN_MADE, KEY_BUILDING, KEY_LEISURE, KEY_AMENITY, KEY_OFFICE, KEY_SHOP, KEY_CRAFT,
                    KEY_EMERGENCY, KEY_TOURISM, KEY_HISTORIC, KEY_LANDUSE, KEY_MILITARY, KEY_NATURAL, KEY_BOUNDARY,
                    KEY_PLACE, KEY_TYPE, KEY_ENTRANCE, KEY_PIPELINE, KEY_HEALTHCARE, KEY_GEOLOGICAL)));
    /** ways that we might want to render differently */
    public static final Set<String> WAY_TAGS          = Collections
            .unmodifiableSet(new HashSet<>(Arrays.asList(KEY_BUILDING, KEY_RAILWAY, KEY_LEISURE, KEY_LANDUSE,
                    KEY_WATERWAY, KEY_NATURAL, KEY_ADDR_INTERPOLATION, KEY_BOUNDARY, KEY_MAN_MADE, KEY_AMENITY,
                    KEY_SHOP, KEY_POWER, KEY_AERIALWAY, KEY_MILITARY, KEY_HISTORIC, KEY_INDOOR, KEY_BUILDING_PART)));
    /** relations that we might want to render differently */
    public static final Set<String> RELATION_TAGS     = Collections.unmodifiableSet(new HashSet<>(Arrays
            .asList(KEY_BOUNDARY, KEY_LEISURE, KEY_LANDUSE, KEY_NATURAL, KEY_WATERWAY, KEY_BUILDING, KEY_MAN_MADE)));
